...
> **VRAM math quan trọng:** DPO cần *cả policy và reference* model trong memory cùng lúc → ~2× SFT VRAM. Một 7B QLoRA SFT vừa 10 GB nhưng 7B QLoRA DPO cần ~18-20 GB. Đó là lý do T4 tier mặc định dùng Llama 3.2 1B để giảm OOM/runtime issues, còn BigGPU tier mới đẩy lên 7B.
